...
{
    public record GetReportsByPeriodQuery(Guid DoctorId, ReportPeriodType PeriodType, int PageNumber = 1, int PageSize = 10)
    : IRequest<ApiResponseDto<PagedResultDto<DoctorPerformanceReportDto>>>;
