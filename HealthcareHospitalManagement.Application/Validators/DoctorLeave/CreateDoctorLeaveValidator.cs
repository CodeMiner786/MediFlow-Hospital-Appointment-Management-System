...
{
    public class CreateDoctorLeaveValidator : AbstractValidator<CreateDoctorLeaveDto>
    {
        public CreateDoctorLeaveValidator()
        {
            ...
            RuleFor(x => x.LeaveFrom)
                ...
                .GreaterThanOrEqualTo(DateTime.Today).WithMessage("Leave start date must be today or in the future.");
