...
{
    public class CreateDoctorNotificationValidator : AbstractValidator<CreateDoctorNotificationDto>
    {
        public CreateDoctorNotificationValidator()
        {
